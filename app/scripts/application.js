...
(function() {
  ...
  content = React.createElement("header", {
    ...
    "className": 'headline'
  }, "Sojourn"), React.createElement("h2", {
    "className": 'byline'
  }, "Highly disposable front-end boilerplate"), React.createElement("h2", {
    "className": 'byline'
  }, "Script with React + Browserify + CoffeeScript"), React.createElement("h2", {
    "className": 'byline'
  }, "Visualize with Bourbon + Sass + Font Awesome"), React.createElement("h2", {
    "className": 'byline'
  }, "Keep everything tested with Mocha + Expect"));

  React.render(content, body);

}).call(this);

},{"react":147,"underscore":148}]},{},[149])